...
def process_flow(leak_confirm, damage_confirm, equipment_type, sub_equipment_type, low_risk, thickness_available, current_thickness, required_thickness):
    if leak_confirm == "Yes":
        return "<h4 style='font-size:14px; font-family:Tw Cen MT;'>CR-GR-HSE-426 - found at <a href='https://prgrefep.cloud.total/_layouts' target='_blank'>Reference Link</a></h4>"
